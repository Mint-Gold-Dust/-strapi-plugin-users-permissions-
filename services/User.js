...
module.exports = {
  ...
  fetchAuthenticatedUser(id) {
    return strapi.query('user', 'users-permissions').findOne({ id }, ['role', 'artworks', 'collected', 'memoirs', 'interviews', 'orders', 'links']);
  },
  ...
  async updateNonce(user) {
    ...
    // save nonce
    await this.edit({ id: user.id }, { nonce });

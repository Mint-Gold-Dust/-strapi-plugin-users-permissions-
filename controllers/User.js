...
module.exports = {
  ...
  async me(ctx) {
    ...
    user = await strapi.plugins['users-permissions'].services.user.fetch({ id: user.id }, ['minted_artworks', 'owned_artworks', 'placed_orders', 'fulfilled_orders', 'stats', 'memoirs', 'interviews', 'links'])
